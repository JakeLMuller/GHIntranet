var PnpConvos = {
    ...
    DrawAllConvos: function (json,p) {
        ...
        for (var i = 0; i < data.length; i++){
            ...
            PnpConvos.drawConvoDropdowns(ViewIcon, ImgContainer, [{ "Label": "Add People To Convo" }, { "Label": "Delete Convo" }, ], "80px", "200px");
    ...
    DrawMessages: function (json, p) {
        ...
        sendButton.onclick = function () {
            ...
            var temp1 = GHVHS.DOM.send({ "URL": "/PnP/getPolicesMessages?ConvoId=" + convoData[1] + "&MessageId=" + Numbered + "&Body=" + message + "&SingleUser=" + userName + "&ScriptAs=Create", "Callback": UpdatedList, "CallbackParams": [] });
        }
    },
    ConvoId:"",
        ...
        for (var i = 0; i < list.length; i++) {
            ...
            if (list[i]["Label"] == "Delete") {
                ...
                SingleOption.onclick = function () {
                    ...
                    var linktoIframe = "/PnP/ViewItem/DraftPolicies?itemId=" + thisId;
    ...
    EditMessage: function (element, messageId, convoId) {
        ...
        sendButton.onclick = function () {
            ...
            var temp1 = GHVHS.DOM.send({ "URL": "/PnP/getPolicesMessages?ConvoId=" + convoId + "&MessageId=" + messageId + "&Body=" + messageArea.value +"&SingleUser="+theUsername+ "&ScriptAs=Update", "Callback": UpdatedList, "CallbackParams": [] });
