var Pnp = {
    ...
    Categories: [],
    Navigation: [],
    CheckPlatformRunningIEBroswer: function () {
        var getBroswer = GHVHS.DOM.getBrowserType();
        if (getBroswer == "IE") {
            alert("It is recommended that you don't use IE when viewing this page. Please Use Chrome or Firefox when viewing this page");
        }
    },
    ...
    ViewItem: function (id, Username, FullName, ViewOnly) {
        ...
        //alert user to use chrome when viewing single policies page
        Pnp.CheckPlatformRunningIEBroswer();
        ...
        function DrawSingleItem(json, p) {
            ...
            function fallbackCopyTextToClipboard(text) {
                ...
                try {
                    ...
                    alert('Copying ' + text +' to clipboard command was ' + msg);
                } catch (err) {
