...
var Fax = {
    ...
    DrawAllFax: function (Json, Tabs, T, T2, page,TableName,RowNames,path, route, ViewOnly) {
        ...
        FaxContainer = GHVHS.DOM.create({ "Type": "div", "Class": "FaxContainer", "Id": "FaxContainer", "Parent": document.getElementById('MainContent') });
        FaxMidDrift = GHVHS.DOM.create({ "Type": "div", "Class": "FaxMidDrift", "Id": "FaxMidDrift", "Parent": FaxContainer });

        SearchAndPage = GHVHS.DOM.create({ "Type": "div", "Class": "SearchAndPage", "Id": "SearchAndPage", "Parent": FaxContainer });
        SearchAndPageLabal = GHVHS.DOM.create({ "Type": "div", "Class": "SearchAndPageLabal", "Content": T2 + " Faxes", "Id": "SearchAndPageLabal", "Parent": SearchAndPage });
        ...
        FaxTable = GHVHS.DOM.create({ "Type": "div", "Class": "FaxTable", "Id": "FaxTable", "Parent": FaxContainer });
...
PtFaxDetail: function (PtJson, OgService, AllSerives, ServiceJson, route, path, ViewOnly) {
    ...
    localFrame = GHVHS.DOM.create({ "Type": "iframe", "Class": "framedTif", "Id": "tiffy", "Style": "position: absolute;right: 5%;top:350px;height: 70%;margin-top:8%;margin-bottom:1%; width: 35%; border: none; box-shadow: rgb(68, 68, 68) 2px 2px 3px;", "Parent": masterElem });
